...
const PostCreate: React.FC<PostCreateProps> = (props) => {
  // Destructure onPostCreated from props inside the function body
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Fix: Check if props.onPostCreated exists before calling it
      if (props.onPostCreated) {
        props.onPostCreated(data as Post);
      }
    } catch (error: any) {
      console.error('Error creating post:', error);
